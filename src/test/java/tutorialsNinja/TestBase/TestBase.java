...
public class TestBase {
	...
	public TestBase() throws Exception {
		prop = new Properties();
		ip = new FileInputStream(System.getProperty("user.dir") + "\\src\\main\\java\\tutorialsNinja\\Config\\Config.properties");
	    prop.load(ip);
	    
	    dataProp = new Properties();
	    ip = new FileInputStream( System.getProperty("user.dir") + "\\src\\test\\java\\tutorialsNinja\\TestData\\testData.properties");
	    dataProp.load(ip);
	}
